...
//Xử lý login admin
Route::get('admin/login', [AuthController::class, 'getlogin'])->name('auth.getlogin'); //link cố định( ví dụ)
Route::post('admin/login', [AuthController::class, 'postlogin'])->name('auth.postlogin'); //link cố định( ví dụ)
