                        <div class="row">
                            <div class="col-md-9">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="detail" id="detail" class="form-control" placeholder="Chi tiết sản phẩm"> 
                                        {{ old('detail') }}</textarea>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="category_id" name="category_id">
                                        <option value="">--Cấp danh mục--</option>
                                        {!! $html_category_id !!}
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="price_buy" value=" {{ old('price_buy') }}" id="price_buy"
